 ...
 * @author sunjiv6
 */
public interface RetrieveAdsContentService {
    ...
    public List<RetrieveAdsContent> getAdsInPagesByCategory(int pageNumber,int pageSize,String address,String adType,String selectedCategory,String prodOrBznzType) throws Exception;
