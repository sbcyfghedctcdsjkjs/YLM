...
import com.bananabkend.bananaBkEnd1A.service.publicViewServices.RetrieveProductContentService;
 ...
 * @author sunjiv6
 */
@Api(value = "OwnerListProduct", tags = {"REST APIs to receive Product!!!!","OwnerContent"})
@RestController
@RequestMapping("/ownerListProduct")
public class OwnerListProduct {

    UserAdViewerService userAdViewerService;
    OwnerContentService ownerContentService;
    UserOwnerService userOwnerService;   
    ApiKeyService apiKeyService;
    RetrieveProductContentService retrieveProductContentService;
    AdViewerLikedItService adViewerLikedItService; 
    PricingService pricingService;
    public OwnerListProduct(OwnerContentService ownerContentService, UserOwnerService userOwnerService,
            UserAdViewerService userAdViewerService,AdViewerLikedItService adViewerLikedItService,
            PricingService pricingService ,ApiKeyService apiKeyService,RetrieveProductContentService retrieveProductContentService) {
        this.ownerContentService = ownerContentService;
        this.userOwnerService = userOwnerService;
        this.apiKeyService = apiKeyService;
        this.userAdViewerService =userAdViewerService;
        this.retrieveProductContentService= retrieveProductContentService;
...
//    START TRying
            ...
            @PathVariable String apiUniqueId,@PathVariable String apiKey,@ModelAttribute AnonymousDto anoDto,BindingResult bindingResult) 
    {
        ...
        try{        
            ...
            ArrayList<AnonymousDto> pricingList;
...
//                dtoOwnerContent.setActiveDate_vb(modelOwnerContent.getActiveDate());
                ...
                sanoDto.setP16(dtoOwnerContentList);
                pricingList = createPricingList(modelOwnerContent.getId());
                sanoDto.setP16(pricingList);
...
//        userAdViewer.setSecretNumber(ownerContentDto.getSecretNumber_vb());
       ...
       try{        
            ...
            if(retrieveAdsContent.getSelectedFilters().equals(",") ||retrieveAdsContent.getSelectedFilters().equals("undefined")){
                listAdsContent = this.retrieveProductContentService.getProductsInPages(pageNum,
                                                        ContentStatus.WebPageSizeOrTotalRecordsSentToUI,
                                                        searchStr.toUpperCase(),
                                                        retrieveAdsContent.getSelectedAdtype(),prodType);
            }else{
                listAdsContent = this.retrieveProductContentService.getProductsInPagesByCategory(pageNum,
                                                        ContentStatus.WebPageSizeOrTotalRecordsSentToUI,
                                                        searchStr.toUpperCase(),
                                                        retrieveAdsContent.getSelectedAdtype(),
                                                        retrieveAdsContent.getSelectedFilters(),prodType);
            }
