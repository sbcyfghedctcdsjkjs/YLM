 ...
 */
@Repository
public class RetrieveProductsInPagesByCategoryRepo {
...
//    }
    ...
    public RetrieveProductsInPagesByCategoryRepo(EntityManager entityManager) {
        this.entityManager = entityManager;
    }
    
    //ForMySQL
    public List<RetrieveAdsContent> getProductsInPagesByCategory(int pageNumber,int pageSize,String address,String adType,
	...
	String qryStr1= "select new com.bananabkend.bananaBkEnd1A.model.publicViewModel.RetrieveAdsContent(c.id,c.contentDesc,"
            +  "c.uploadedFileName,c.adType,c.createdOn,c.adDisplayType,c.activeDate,"+pageNumber+",p.price,p.unitDetail,c.contentName) "                
            +  " from OwnerTargetArea t,OwnerContent c,Pricing p where "
    ...
    //For H2
    public List<RetrieveAdsContent> getProductsInPagesByCategoryForH2Database(int pageNumber,int pageSize,String address,String adType,String selectedCategory)
    {
        String p1="% "+address+"";
        String p2=""+address+" %";
        String p3="% "+address+" %";
