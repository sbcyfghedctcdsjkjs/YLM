...
@Repository
public class AdViewerLikedItInPagesByCategoryRepo {
 private EntityManager entityManager;
 
        public AdViewerLikedItInPagesByCategoryRepo(EntityManager entityManager) {
        this.entityManager = entityManager;
    
    }
    
    //ForMySQL
    public List<RetrieveAdsContent> getLikedAdsAdsInPagesByCategory(int pageNumber,int pageSize,String adType,
            String selectedCategory,String likedIds,Long adViewerId)
    {
...
//            +  " or t.allTargets like :p6) "
        ...
        query.setParameter("likedIds", likedIds);
