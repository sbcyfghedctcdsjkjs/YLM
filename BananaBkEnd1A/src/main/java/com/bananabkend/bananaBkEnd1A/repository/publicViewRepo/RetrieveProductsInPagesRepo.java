 ...
 */
@Repository
public class RetrieveProductsInPagesRepo {
...
//    }
    ...
    public RetrieveProductsInPagesRepo(EntityManager entityManager) {
        this.entityManager = entityManager;
    }
    
    public List<RetrieveAdsContent> getProductsInPages(int pageNumber,int pageSize,String address,String adType,String prodOrBznzType)
    {
        String p1="% "+address+"";
        String p2=""+address+" %";
        String p3="% "+address+" %";
    ...
    public List<RetrieveAdsContent> getProductsInPages1(int pageNumber,int pageSize,String address,String adType)
    {
        String p1="% "+address+"";
        String p2=""+address+" %";
        String p3="% "+address+" %";
