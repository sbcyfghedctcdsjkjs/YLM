...
class FetchAdsViewModel_cl {
  FetchAdsContent_cl _fetchAdsContent_vb;

  FetchAdsViewModel_cl({FetchAdsContent_cl fetchAdsContent_vb}) : _fetchAdsContent_vb = fetchAdsContent_vb;

  String get ownerPhone_mt {
    return _fetchAdsContent_vb.ownerPhone_vb;
  }

  String get ownerEmail_mt {
    return _fetchAdsContent_vb.ownerEmail_vb;
  }

  String get secretNumber_mt {
    return _fetchAdsContent_vb.secretNumber_vb;
  }

  String get adType_mt {
    return _fetchAdsContent_vb.adType_vb;
  }

  String get status_mt {
    return _fetchAdsContent_vb.status_vb;
  }

  String get contentDesc_mt {
    return _fetchAdsContent_vb.contentDesc_vb;
  }

  String get adDisplayType_mt {
    return _fetchAdsContent_vb.adDisplayType_vb;
  }

  String get adId_mt {
    return _fetchAdsContent_vb.adId_vb;
  }

  String get createdDate_mt {
    return _fetchAdsContent_vb.createdDate_vb;
  }
  ...
  String get publishedAt_mt {
        ...
        return DateTime.fromMillisecondsSinceEpoch(int.parse(_fetchAdsContent_vb.createdDate_vb)).toString();

//    return DateFormat.yMMMMEEEEd('en-us').format(dateTime).toString();
  }

  void set likedIt_mt(bool v) {
    _fetchAdsContent_vb.likedIt_vb=v;
  }

  bool get likedIt_mt {
    return _fetchAdsContent_vb.likedIt_vb;
  }

  int get pageNum_mt {
    return _fetchAdsContent_vb.pageNum_vb;
  }
}
