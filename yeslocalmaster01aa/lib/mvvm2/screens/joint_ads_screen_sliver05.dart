...
class JointAdsGridListScreenSliver05_cl extends StatefulWidget {
  @override
  _AdsScreenState_cl createState() => _AdsScreenState_cl();
}

class _AdsScreenState_cl extends State<JointAdsGridListScreenSliver05_cl> {
  ...
  void initState() {
    _body =  mainAdScreen();
    //_gotoHomeScreen();//https://stackoverflow.com/questions/58728607/how-do-i-wait-for-an-async-function-to-finish-executing-before-rendering-a-widge
    super.initState();
  }
  ...
  likeIconButtonFunction_mt(id_vb,index_vb)
  {
    ...
    setState(() {
      this.likeIcon_Temp="OnPress i="+(i++).toString();
    });
    //if(index_vb==2)
    {
  ...
  Widget mainAdScreen() => new Scaffold(
    appBar: new AppBar(
                ...
                child:  Card(
                  ...
                  child:  Column(
                      ...
                      children: <Widget>[
                              ...
                              new Row(
                                ...
                                children: <Widget>[
                                  new IconButton(
                                    key: UniqueKey(),
                                    iconSize:  deviceSize_vb.height * 0.15*.23,
                                    icon: this.likeIcon_Temp.endsWith("OnLoad") ? Icon(Icons.thumb_up): Icon(Icons.eighteen_mp),
                                    color: this.likeIcon_Temp.endsWith("OnLoad") ? Colors.blue: Colors.black,
                                      onPressed: (){
                                        setState(() {
                                          this.likeIcon_Temp = 'OnPress';
                                          this.likeIcon_Temp.endsWith("OnLoad") ? print('onLoad true'):print('onpress false');
                                          print('this.likeIcon_Temp: '+this.likeIcon_Temp);
                                        });
                                    ...
                                    // onPressed: (){
                                    //   setState(() => this.likeIcon_Temp = 'OnPress');
                                    // }
                                    //onPressed: toggleColor,
                                    // onPressed: () {
                                    //   likeIconButtonFunction_mt(vs_vb.myAdsVMList_vb[index].adId_mt,index);
                                    //   setState((){
                                    //     this.userInfo_vb.getLikedAdsAtOnLoad_mt.contains(","+vs_vb.myAdsVMList_vb[index].adId_mt.toString()+",")  ? Colors.lightBlue : Colors.black;
                                    //   }
                                    //   );
                                    // },
                                  ),
                        ...
                        //   child:Text(
                        //     vs_vb.myAdsVMList_vb[index].contentDesc_mt+" && "+this.likeIcon_Temp ,//Description section
                        //     key: UniqueKey(),
                        //     style: TextStyle(
