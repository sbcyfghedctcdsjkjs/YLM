...
class JointAdsGridListScreenSliver_cl2 extends StatefulWidget {
  @override
  _AdsScreenState_cl2 createState() => _AdsScreenState_cl2();
}

class _AdsScreenState_cl2 extends State<JointAdsGridListScreenSliver_cl2> {
                        ...
                        Padding(
                          ...
                          child:Text(
                            vs_vb.myAdsVMList_vb[index].contentDesc_mt +" SANJEECV: "+DateTime.now().toString()
                                ...
                                +     "I am extremely excited to announce that I am officially joining the team at Tipalti as a Sales Development Representative!"
                                +     "I am extremely excited to announce that I am officially joining the team at Tipalti as a Sales Development Representative!"
                                +     "I am extremely excited to announce that I am officially joining the team at Tipalti as a Sales Development Representative!"
                                +     "I am extremely excited to announce that I am officially joining the team at Tipalti as a Sales Development Representative!"
                                +     "I am extremely excited to announce that I am officially joining the team at Tipalti as a Sales Development Representative!"
