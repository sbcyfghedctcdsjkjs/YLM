...
class joint_ads_screen_sliver_before_mayhem_cl extends StatefulWidget {
  @override
  _AdsScreenState_cl createState() => _AdsScreenState_cl();
}

class _AdsScreenState_cl extends State<joint_ads_screen_sliver_before_mayhem_cl> {
  ...
  void _gotoHomeScreen() {
   ...
   toggleColor(){
    setState(() {
      if(this.likeIcon_Temp.endsWith("OnLoad")){
        this.likeIcon_Temp="OnPress";
      }else{
        this.likeIcon_Temp="OnLoad";
      }
    });
  }
  @override
