...
class JointAdsGridListScreenSliver02_cl extends StatefulWidget {
  @override
  _AdsScreenState_cl createState() => _AdsScreenState_cl();
}

class _AdsScreenState_cl extends State<JointAdsGridListScreenSliver02_cl> {
                              ...
                              new Row(
                                ...
                                children: <Widget>[
                                  new LikeIconButton_cl(
                                    ...
                                    //pbool: this.userInfo_vb.getLikedAdsAtOnLoad_mt.contains(","+vs_vb.myAdsVMList_vb[index].adId_mt.toString()+",")  ? true : false,
