...
class DemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(DemoLocalizations.of(context).sampleAddressFormat),
      ),
      body: Center(
        child: Text(DemoLocalizations.of(context).sampleAddressFormat),
      ),
    );
  }
}
...
class Demo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      onGenerateTitle: (BuildContext context) => DemoLocalizations.of(context).sampleAddressFormat,
